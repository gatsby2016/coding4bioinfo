### DATA
d <- read.table("SC3/Data/Goolam/Goolam_et_al_2015_count_table.tsv", header = T)
...
write.table(ann, "SC3/Data/Goolam/cell_types_export_from_R.txt")
write.csv(d, "SC3/Data/Goolam/goolam_export_from_R.csv")
...
saveRDS(sceset, "SC3/Data/Goolam/goolam.rds")
